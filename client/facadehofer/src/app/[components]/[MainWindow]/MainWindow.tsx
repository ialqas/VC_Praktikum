...
function mainWindow() {
    ...
    <div className="border-double border-8 border-cyan-500 grid flex flex-col h-[100vh] items-center justify-center">
        <div className="relative border-solid border-4 border-indigo-600 flex w-[100vh] h-[95%] items-center justify-center">
        <StepWindow step={step} setStep={setStep} />
        </div>
        <div className="relative hidden border-solid border-4 border-indigo-600 flex w-[100vh] h-[5%] items-center justify-center">

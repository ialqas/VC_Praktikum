    ...
    return (
        <div className="flex flex-col justify-center items-center space-y-6">
            <div className="flex flex-row items-center space-x-6">        
                    <input className="border-2 border-gray-500" type="text" placeholder="Street" value="Wenckstraße" onChange = {(event) => setStreet(event.target.value)}/>
                    <input className="border-2 border-gray-500" type="text" placeholder="Housenumber" value="13" onChange = {(event) => setHousenumber(event.target.value)}/>
                    <input className="border-2 border-gray-500" type="number" placeholder="Postal Code" value="64295" onChange = {(event) => setPostalCode(event.target.value)}/>
                    <input className="border-2 border-gray-500" type="text" placeholder="City" value="Darmstadt" onChange = {(event) => setCity(event.target.value)}/>
            </div>
